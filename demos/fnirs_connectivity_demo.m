...
figure;
nirs.util.plotroc([ones(num_iter,1); zeros(num_iter,1)]',abs([Ppos(:,1); Pneg(:,1)])','corr',...
        [ones(num_iter,1); zeros(num_iter,1)]',abs([Ppos(:,2); Pneg(:,2)])','ar-corr',...
        [ones(num_iter,1); zeros(num_iter,1)]',abs([Ppos(:,3); Pneg(:,3)])','robust ar-corr')
